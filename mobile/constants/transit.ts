...
export const transitSections: TransitSection[] = [
  ...
  },
  {
    id: 'funicular',
    title: 'Funiculars',
    blurb: 'Three of the four historic cable railways up to Vomero are running — Montesanto is currently closed for repairs. Use Centrale or Chiaia instead.',
    icon: 'trending-up',
    color: '#C79A2E',
    lines: [
      {
        name: 'Centrale',
        tag: 'Best option',
        route: 'Augusteo (Via Toledo) ↔ Fuga (Vomero).',
        hours: 'Mon–Tue 07:00–22:30 · Wed–Sun 07:00–00:30',
        freq: 'Every ~10 min',
        note: 'Your go-to for Vomero from the centre. Runs latest of any funicular most nights — and it\'s the closest to the main shopping street. Accepts contactless tap-in.',
      ...
      },
      {
        ...
        hours: 'Mon–Tue 07:00–00:30 · Wed–Thu 07:00–22:30 · Fri–Sat 07:00–02:00 · Sun 07:00–00:30',
        freq: 'Every ~10 min',
        note: 'Best funicular for late nights out — runs until 2:00 am on Fridays and Saturdays. Departs from the Chiaia/Mergellina end of the city. Accepts contactless tap-in.',
      ...
      },
      {
        ...
        hours: 'Currently suspended — no reopening date announced',
        note: 'ANM is carrying out works on the Vomero section. Use Centrale (from Toledo) or Chiaia (from Parco Margherita) while it\'s out. Reconnects to the Cumana and Line 2 at Montesanto.',
        url: 'https://www.anm.it/s/linea-anm/a0Y7Q000007MPlNUAW/funicolare-montesanto',
      },
      {
        name: 'Mergellina',
        route: 'Mergellina ↔ Manzoni (Posillipo).',
        hours: '07:00–22:00 daily (Sat from 07:05). Subject to maintenance windows.',
        freq: 'Every ~10 min',
        note: 'Takes you up to Posillipo for sweeping views over the bay. Less useful day-to-day but great for the panorama.',
